...
class BaseLog extends BaseModel{
    ...
    public static function insert($oldValue, $newValue, $field, $sourceID, $oldValueLabel, $newValueLabel, $fieldLabel,$updatedFromLabel){
        DB::insert(array("oldValue"=> $oldValue, "newValue"=>$newValue, "field" => $field, "sourceID" =>$sourceID, "fieldLabel" => $fieldLabel, "oldValueLabel" => $oldValueLabel, "newValueLabel" => $newValueLabel, "updatedFromLabel" => $updatedFromLabel) ,static::class);
    }
